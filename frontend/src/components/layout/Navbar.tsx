    ...
    <nav className="border-b border-[var(--color-border)] bg-[var(--color-surface)]">
      <div className="max-w-5xl mx-auto flex items-center justify-between px-6 h-14">
        <Link href="/" className="font-semibold text-lg tracking-tight flex items-center gap-2">
          <span className="w-7 h-7 rounded-lg bg-[var(--color-ink)] flex items-center justify-center">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            href="/upload"
            className="text-sm px-4 py-1.5 rounded-lg bg-[var(--color-ink)] text-white hover:opacity-90 transition-opacity font-medium"
          >
            Upload
          </Link>
        </div>
